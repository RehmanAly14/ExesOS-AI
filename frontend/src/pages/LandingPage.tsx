...
export default function LandingPage() {
  ...
  return (
    <div className="h-screen overflow-auto bg-[#0b1326] text-[#dae2fd]">
      {/* Top Nav */}
      <header className="sticky top-0 z-50 bg-[#080f1f]/90 backdrop-blur-2xl border-b border-white/[0.06] shadow-[0_1px_0_0_rgba(255,255,255,0.04),0_4px_24px_rgba(0,0,0,0.4)]">
        ...
        <nav className="flex justify-between items-center w-full px-4 sm:px-6 py-3.5 max-w-[1440px] mx-auto">
          <div className="flex items-center gap-8">
            <span className="text-lg sm:text-xl font-bold tracking-tight text-violet-300">ExecOS AI</span>
            <div className="hidden md:flex gap-6 items-center">
              <a href="#features" className="text-[#cbc3d7] hover:text-violet-300 transition-colors text-sm">Features</a>
              <a href="#pricing" className="text-[#cbc3d7] hover:text-violet-300 transition-colors text-sm">Pricing</a>
              <a href="#integrations" className="text-[#cbc3d7] hover:text-violet-300 transition-colors text-sm">Integrations</a>
            </div>
          </div>
      ...
      <main>
        ...
        <section className="relative pt-16 sm:pt-24 pb-12 sm:pb-20 overflow-hidden">
          {/* Background orbs */}
          <div className="absolute top-[-15%] left-[-10%] w-[50%] h-[60%] bg-violet-500/10 rounded-full pointer-events-none blur-[120px]" />
          <div className="absolute bottom-[-15%] right-[-10%] w-[40%] h-[50%] bg-cyan-500/8 rounded-full pointer-events-none blur-[120px]" />

          <div className="max-w-[1440px] mx-auto px-4 sm:px-6 grid lg:grid-cols-2 gap-12 items-center relative z-10">
            {/* Left Content */}
            <div className="space-y-5 text-center lg:text-left">
              <div className="inline-flex items-center gap-2 bg-violet-500/10 border border-violet-500/20 px-3.5 py-1.5 rounded-full text-violet-300 text-xs font-medium tracking-wide">
                <Zap className="w-3.5 h-3.5" />
                AI-Powered Business OS
              </div>

              <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-[#dae2fd] leading-[1.1]">
              ...
              <p className="text-[#cbc3d7] text-base max-w-lg mx-auto lg:mx-0 leading-relaxed">
            ...
            <div className="hidden lg:flex items-center justify-center">
              <div className="relative w-full max-w-md aspect-square">
                ...
                <div className="absolute top-8 left-8 bg-[rgba(23,31,51,0.9)] backdrop-blur-xl border border-white/8 rounded-2xl p-4 shadow-2xl">
                ...
                <div className="absolute bottom-12 right-6 bg-[rgba(23,31,51,0.9)] backdrop-blur-xl border border-white/8 rounded-2xl p-4 shadow-2xl">
                  <div className="flex items-center gap-3">
        ...
        <section id="features" className="py-16 bg-[#060e20]/40">
          <div className="max-w-[1440px] mx-auto px-4 sm:px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {/* Agent 1 - CEO */}
              <div className="bg-[rgba(23,31,51,0.72)] backdrop-blur-xl border border-white/8 rounded-2xl p-6 hover:border-violet-500/30 transition-all group">
              ...
              {/* Agent 2 - Finance */}
              <div className="bg-[rgba(23,31,51,0.72)] backdrop-blur-xl border border-white/8 rounded-2xl p-6 hover:border-cyan-500/30 transition-all group">
                <div className="flex items-center gap-3 mb-3">
              ...
              {/* Agent 3 - Marketing */}
              <div className="bg-[rgba(23,31,51,0.72)] backdrop-blur-xl border border-white/8 rounded-2xl p-6 hover:border-blue-500/30 transition-all group">
                <div className="flex items-center gap-3 mb-3">
              ...
              {/* Agent 4 - Operations */}
              <div className="bg-[rgba(23,31,51,0.72)] backdrop-blur-xl border border-white/8 rounded-2xl p-6 hover:border-emerald-500/30 transition-all group">
                <div className="flex items-center gap-3 mb-3">
              ...
              {/* Agent 5 - Sales */}
              <div className="bg-[rgba(23,31,51,0.72)] backdrop-blur-xl border border-white/8 rounded-2xl p-6 hover:border-amber-500/30 transition-all group">
                <div className="flex items-center gap-3 mb-3">
              ...
              {/* Agent 6 - HR */}
              <div className="bg-[rgba(23,31,51,0.72)] backdrop-blur-xl border border-white/8 rounded-2xl p-6 hover:border-rose-500/30 transition-all group">
                <div className="flex items-center gap-3 mb-3">
        ...
        <section id="integrations" className="py-16">
          <div className="max-w-[1440px] mx-auto px-4 sm:px-6">
            <h2 className="text-xl font-semibold text-[#dae2fd] mb-4">Integrated Ecosystem</h2>
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
              {integrations.map((item, i) => (
                <div key={i} className="flex items-center gap-2 bg-[#222a3d]/40 border border-white/8 px-3 py-2.5 rounded-xl">
        ...
        <section id="pricing" className="py-16 relative">
          <div className="max-w-[1440px] mx-auto px-4 sm:px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="bg-[rgba(23,31,51,0.72)] backdrop-blur-xl border border-white/8 rounded-2xl p-6 flex flex-col hover:border-violet-500/30 transition-colors">
              ...
              <div className="bg-[rgba(23,31,51,0.72)] backdrop-blur-xl border border-violet-500/40 rounded-2xl p-6 flex flex-col relative bg-violet-500/5">
        ...
        <section className="py-16 relative overflow-hidden">
          <div className="max-w-3xl mx-auto px-4 relative z-10 text-center bg-[rgba(23,31,51,0.72)] backdrop-blur-xl border border-violet-500/20 rounded-3xl py-12">
      ...
      <footer className="bg-[#060e20] py-8 border-t border-white/5">
        <div className="max-w-[1440px] mx-auto px-4 sm:px-6 flex flex-col md:flex-row justify-between items-center gap-3">
