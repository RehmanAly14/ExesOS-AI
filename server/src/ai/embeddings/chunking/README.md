...
- **Metadata Preservation**: Every chunk must inherit its parent document's metadata (workspace ID, business ID, document ID, title, etc.) while appending chunk-specific metadata (index, relative byte/character offset).
